    ...
    <Transition name="popup-fade">
      ...
      >
        <div
          ...
          @click.stop
        >
          <!-- Header with miku gradient -->
          <div class="relative overflow-hidden border-b border-teal-100/80 bg-gradient-to-br from-teal-50/80 via-cyan-50/50 to-emerald-50/30 px-8 py-6 dark:border-dark-700/50 dark:from-teal-900/20 dark:via-cyan-900/10 dark:to-emerald-900/5">
            ...
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-600 px-2.5 py-1 text-xs font-medium text-white shadow-lg shadow-teal-500/30">
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-xl bg-gradient-to-r from-teal-500 to-cyan-600 px-6 py-2.5 text-sm font-medium text-white shadow-lg shadow-teal-500/30 transition-all hover:shadow-xl hover:scale-105"
              >
