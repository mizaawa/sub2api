<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-2xl bg-[var(--surface-1)] shadow-2xl ring-1 ring-[var(--border)]"
          @click.stop
        >
          <!-- Header -->
          <div class="relative overflow-hidden border-b border-[var(--border)] bg-[var(--surface-2)] px-8 py-6">
            <div class="relative z-10">
              <!-- Icon and badge -->
              <div class="mb-3 flex items-center gap-2">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--accent)] text-white shadow-lg">
                  <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                </div>
                <span class="inline-flex items-center gap-1.5 rounded-full bg-[var(--accent)] px-3 py-1 text-xs font-medium text-white shadow-lg">
              ...
              <!-- Title -->
              <h2 class="mb-2 text-2xl font-bold leading-tight text-[var(--text-primary)]">
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-[var(--surface-1)] px-8 py-8">
            <div class="relative">
              <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-[var(--accent)]"></div>
              <div class="pl-6">
                <div
          ...
          <!-- Footer -->
          <div class="border-t border-[var(--border)] bg-[var(--surface-2)] px-8 py-5">
            <div class="flex items-center justify-end">
              <button
                @click="handleDismiss"
                data-testid="announcement-popup-dismiss"
                class="rounded-xl bg-[var(--accent)] px-6 py-2.5 text-sm font-medium text-white shadow-lg transition-all hover:opacity-90 hover:scale-105"
              >
