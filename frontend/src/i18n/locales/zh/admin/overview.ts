export default {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: '仅限制客户端主动请求的 OpenAI-compatible reasoning effort；Custom 分组请求同样生效。超过上限时自动降档，不会为缺省请求主动开启推理。上限优先级高于推理强度映射。',
      ...
      compositeRoutes: {
        ...
        routeCreated: 'Custom 路由已创建',
        routeUpdated: 'Custom 路由已更新',
        routeDeleted: 'Custom 路由已删除',
        failedToLoad: '加载 Custom 路由失败',
        failedToSave: '保存 Custom 路由失败',
        failedToDelete: '删除 Custom 路由失败',
        failedToPreview: '预览 Custom 路由失败',
        deleteConfirm: '确定删除此 Custom 路由？',
        endpoints: {
          any: '任意',
          messages: 'Messages',
