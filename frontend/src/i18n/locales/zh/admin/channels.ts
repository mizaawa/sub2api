export default {
    ...
    channelMonitor: {
      ...
      createButton: '新增监控',
      sortOrder: '监控排序',
      sortOrderHint: '拖拽调整渠道监控顺序。该顺序会同步应用到用户状态页。',
      sortOrderCount: '{count} 个渠道',
      sortOrderEmptyProvider: '此平台暂无渠道监控',
      sortOrderLoadError: '加载渠道监控排序失败',
      sortOrderUpdated: '渠道监控排序已更新',
      sortOrderUpdateError: '更新渠道监控排序失败',
      createTitle: '新增渠道监控',
      editTitle: '编辑渠道监控',
      runNow: '立即检测',
      runSuccess: '检测完成',
      ...
      duplicateKeyUnavailable: '旧监控凭据不可用，请先编辑并选择分组后再复制',
      apiKeyDecryptFailed: '旧监控凭据不可用，请编辑并选择分组',
      ...
      form: {
        name: '名称',
        namePlaceholder: '可选，输入监控名称',
        nameHint: '留空时默认使用所选分组名称',
        provider: '平台',
        group: '选择分组',
        groupPlaceholder: '请选择分组',
        noGroupsAvailable: '当前平台暂无可用分组',
        groupLoadError: '加载分组失败',
        apiMode: 'OpenAI 协议',
      ...
      advanced: {
        ...
        headerNameForbidden: '该 Header 由监控服务管理，不能覆盖：{name}',
        headersHint: '与监控请求头合并；鉴权、内部签名和 hop-by-hop 类 Header 不能覆盖。',
