export default {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit OpenAI-compatible reasoning effort requests, including Custom groups. Higher values are capped; omitted effort stays omitted. The ceiling takes precedence over reasoning effort mappings.',
      ...
      compositeRoutes: {
        action: 'Routes',
        title: 'Custom Routes',
        titleWithGroup: 'Custom Routes: {name}',
        routes: 'Saved Routes',
        empty: 'No Custom routes configured',
        ...
        routeCreated: 'Custom route created',
        routeUpdated: 'Custom route updated',
        routeDeleted: 'Custom route deleted',
        failedToLoad: 'Failed to load Custom routes',
        failedToSave: 'Failed to save Custom route',
        failedToDelete: 'Failed to delete Custom route',
        failedToPreview: 'Failed to preview Custom route',
        deleteConfirm: 'Delete this Custom route?',
        endpoints: {
          any: 'Any',
          messages: 'Messages',
