export default {
    ...
    channelMonitor: {
      ...
      sortOrder: 'Monitor Order',
      sortOrderHint: 'Drag monitors to reorder them. This order is also used on the public status page.',
      sortOrderCount: '{count} monitors',
      sortOrderEmptyProvider: 'No monitors for this platform',
      sortOrderLoadError: 'Failed to load monitor order',
      sortOrderUpdated: 'Monitor order updated',
      sortOrderUpdateError: 'Failed to update monitor order',
      ...
      duplicateKeyUnavailable: 'The legacy monitor credential is unavailable. Edit it and select a group before duplicating.',
      apiKeyDecryptFailed: 'The legacy monitor credential is unavailable. Edit this monitor and select a group.',
      ...
      form: {
        name: 'Name',
        namePlaceholder: 'Optional monitor name',
        nameHint: 'Leave blank to use the selected group name',
        provider: 'Platform',
        group: 'Select Group',
        groupPlaceholder: 'Select a group',
        noGroupsAvailable: 'No groups are available for this platform',
      ...
      advanced: {
        ...
        headerNameForbidden: 'This header is managed by the monitor and cannot be overridden: {name}',
        headersHint: 'Merged with the monitor request. Authentication, internal signature, and hop-by-hop headers cannot be overridden.',
