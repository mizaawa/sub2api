...
func (u *customChannelMappingHTTPUpstream) Do(req *http.Request, _ string, _ int64, _ int) (*http.Response, error) {
...
func newCustomChannelMappingHandler(t *testing.T, mapping map[string]string) (*OpenAIGatewayHandler, *customChannelMappingHTTPUpstream) {
	t.Helper()
