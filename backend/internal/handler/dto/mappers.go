...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		ModelPricing:                service.CloneGroupModelPricing(g.ModelPricing),
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		Status:                          g.Status,
		BlockedForUser:                  g.BlockedForUser,
...
func usageAPIKeyFromService(k *service.APIKey) *UsageAPIKey {
	if k == nil {
		return nil
	}
	return &UsageAPIKey{
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		APIKey:                    usageAPIKeyFromService(l.APIKey),
