...
// 请求头覆写（header override）：对 Anthropic / OpenAI / Custom 平台的 api_key 账号
...
// Anthropic / OpenAI / Custom 仅开放 api_key 账号；Grok 额外开放 oauth 账号——
...
func (a *Account) IsHeaderOverrideEligible() bool {
	...
	switch a.Platform {
	case PlatformAnthropic, PlatformOpenAI, PlatformCustom:
