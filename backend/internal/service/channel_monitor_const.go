...
const (
	...
	// providerCustomPath Custom OpenAI-compatible Chat Completions 路径。
	providerCustomPath = "/v1/chat/completions"
	...
	// MonitorProviderOpenAI / Anthropic / Gemini / Grok / Custom provider 字符串常量（也是 ent enum 的实际值）。
